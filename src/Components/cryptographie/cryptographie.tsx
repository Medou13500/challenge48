                    ...
                    <div className="card-body py-2">
                      ...
                      <ul className="list-group list-group-flush">
                        ...
                        <li className={`list-group-item border-0 bg-transparent ${showHint2 ? '' : 'text-muted'}`}>
                          ...
                          {showHint2 ? (
                            <>🔍 C'est un chiffrement de César avec un décalage de <strong>{shift}</strong>.</>
                          ) : (
                        ...
                        <li className={`list-group-item border-0 bg-transparent ${showHint3 ? '' : 'text-muted'}`}>
                          ...
                          {showHint3 ? (
                            <>🧩 Pour décrypter, utilisez un décalage de <strong>{-shift}</strong> (ou <strong>{26 - shift}</strong>).</>
                          ) : (
