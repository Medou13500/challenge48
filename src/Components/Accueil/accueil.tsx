    ...
    return (
        <div style={{
            ...
            <main className="d-flex justify-content-center align-items-center" style={{ minHeight: '80vh' }}>
                <div className="card p-5" style={{ backgroundColor: 'rgba(255, 255, 255)', borderRadius: '10px', maxWidth: '600px' }}>
                    <p className="lead">
                    ...
                    <div className="text-center mt-3">
                        <button className="btn btn-light btn-lg" style={{ backgroundColor: 'rgba(216, 4, 4, 0.8)', borderRadius: '20px', padding: '10px 30px', fontWeight: 'bold' }}>
                            Commencer le Jeu
                        </button>
                    </div>
                </div>
